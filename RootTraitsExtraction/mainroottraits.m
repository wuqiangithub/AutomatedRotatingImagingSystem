...
function [midpoint_x,midpoint_y,midpoint_z,mainrootlength,SurfaceArea_main,Volume_main]=mainroottraits(BW_main,size_vol);
...
% mainrootlength,SurfaceArea_main,Volume_main: Length,SurfaceArea,Volume of main roots
