...
[x,y,z]=xyzread('D:\Experiment\matlab-pc\RootTraitsExtraction\test-maize.xyz');

% Load the voxelized data
load("test_maizedata.mat");
...
[BW_main,BW_lat]=rootseg_maize(BW_whole,areaexpand_size,minareaexp_size);
%  img_lat=BW_lat;
...
xlswrite('D:\Experiment\matlab-pc\RootTraitsExtraction\Globalroottraits_maize.xlsx',DATAFRAME_G,'Sheet1');
xlswrite('D:\Experiment\matlab-pc\RootTraitsExtraction\Localroottraits_maize.xlsx',DATAFRAME_L,'Sheet1');
xlswrite('D:\Experiment\matlab-pc\RootTraitsExtraction\Rootangle_maize.xlsx',minlabel2middist(:,2:5),'Sheet1');
